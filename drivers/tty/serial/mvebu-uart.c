...
static struct console_operations mvebu_early_cons_ops = {
...
static struct console_operations mvebu_cons_ops = {
...
{
	mvebu_uart_console = init_console_dfl(&mvebu_cons_ops, "ttyMV",
						  &mvebu_uart_driver);
