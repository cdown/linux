...
static struct console_operations altera_cons_ops = {
...
{
	altera_uart_console = init_console_dfl(&altera_cons_ops, "ttyAL",
						   &altera_uart_driver);
...
static struct console_operations altera_early_cons_ops = {
