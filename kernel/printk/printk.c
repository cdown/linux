			    ...
			    size_t count, loff_t *ppos)
{
	...
	if (!printk_get_next_message(&pmsg, NULL, atomic64_read(&user->seq), true, false)) {
		...
		ret = wait_event_interruptible(log_wait,
				printk_get_next_message(&pmsg, NULL, atomic64_read(&user->seq), true,
 ...
 */
static bool printk_get_next_message(struct printk_message *pmsg, struct console *con,
				    u64 seq, bool is_extended, bool may_suppress)
{
