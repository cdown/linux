...
struct pi_entry {
	...
	/*
	 * For printk-likes, the string before the fmt, or at least
	 * something that would match whatever it could be.
	 *
	 * NULL indicates that there is nothing before fmt starts.
	 */
