...
**Concurrent writes to loglevel**: If two processes write to the same
console's loglevel simultaneously, the last write wins. This is standard
behavior for sysfs attributes.
